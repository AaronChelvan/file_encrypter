...
SALT_LENGTH = 29 # Length of the salt generated by bcrypt
...
if FUNCTION == "encrypt":
	...
	with open(INPUT_FILE, 'wb') as f:
		f.write(hashed_password + IV + key_salt + ciphertext)

	print(INPUT_FILE + " has been encrypted")

elif FUNCTION == "decrypt":
	# The encrypted file consists of: hashed passkey + IV + key salt + encrypted data
	hashed_password = file_data[0:HASH_LENGTH]
	IV = file_data[HASH_LENGTH:HASH_LENGTH + BLOCK_SIZE]
	key_salt = file_data[HASH_LENGTH + BLOCK_SIZE:HASH_LENGTH + BLOCK_SIZE + SALT_LENGTH]
	ciphertext = file_data[HASH_LENGTH + BLOCK_SIZE + SALT_LENGTH:]
